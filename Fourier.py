...
print("------------------------------------------------------------------")
print("Las diferencias encontradas entre la transformada de Fourier de la signal original y las interpolaciones es que basicamente las amplitudes centrales se mantienen iguales, pero las interpolaciones generan un mayor riudo a los lados de la funcion")
...
plt.plot(xnew,np.real(invfilter_Cuadmil),label="Signal Cuadratica",color="red")
...
plt.plot(xnew,np.real(invfilter_Cubicquin),label='Signal Cubica',color="blue")
