...
print("------------------------------------------------------------------")
print("#3")
print("El metodo de PCA resulta poco eficiente  a la hora de ver el area y las variables las cuales representan a los casos malignos y benignos. No es posible ver una clara diferencia de estos. A la hora de ver la grafica es posible observar en en un cierto rango de valores bajos tanto de PC1 y PC2 se agrupan los casos benignos, y los casos malignos estan dispersos a los largo de la grafica, de este modo se podria pensar que se clasificaron de manera correcta, pero lo que no es tan facil de notar, es que muchos de los casos malignos se encuentran ocultos debido a los puntos de Benignos, asi que en el area que ocupan todos los casos benignos, tambien hay casos malignos. Por lo tanto, no es posible afirmar que el pca que se realizo dio una correcta correlacion entre las variables para dar un buen diagnostico y automatizar el proceso. Una de las posibles causas de esto, es que a la hora de realizar la matriz de covarianza, no se tuvo en cuenta la debilidad que esta presenta como metodo de correlacion y es que no se tienen en cuenta las uniandades de las variables que se estan procesando.")
